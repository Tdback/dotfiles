...
-- Thank you Emacs habit
vim.keymap.set("n", "<C-g>", "<Esc>") -- This honestly might not do anything, but is there just in case
...
vim.keymap.set("n", "<C-k>", "<cmd>cnext<CR>zz") -- these could conflict with Harpoon
vim.keymap.set("n", "<C-j>", "<cmd>cprev<CR>zz")
vim.keymap.set("n", "<leader>k", "<cmd>lnext<CR>zz")
vim.keymap.set("n", "<leader>j", "<cmd>lprev<CR>zz")

-- Navigate panes the `smart' way
